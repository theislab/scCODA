    ...
    for w in b_w_dict[i][1]:
        ...
        for n in range(10):
            with open("/home/icb/johannes.ostner/compositional_diff/compositionalDiff-johannes_tests_2/paper_simulation_scripts/schedule_script_" + str(count) + ".sh", "w") as fh:
                ...
                fh.writelines("/home/icb/johannes.ostner/anaconda3/bin/python /home/icb/johannes.ostner/compositional_diff/compositionalDiff-johannes_tests_2/paper_simulation_scripts/run_one_job.py " +
                        str(cases).replace(" ", "") + " " +
                        str(K).replace(" ", "") + " " +
                        str(n_total).replace(" ", "") + " " +
